// Inline icon set (Lucide geometry, hand-inlined so nothing loads from a CDN —
// the design's mask-image approach fails on a slow/offline connection).
// Stroke-based, 24×24, inherits `currentColor`.
import type { CSSProperties } from "react";

const SIZES: Record<string, number> = { sm: 16, md: 20, lg: 24, xl: 32 };

// Trusted, author-written inner markup for each glyph.
const PATHS: Record<string, string> = {
  ...
  tractor:
    '<path d="M3 4h9l1 7"/><path d="M4 11V4"/><path d="M8 10V4"/><path d="M18 5c-.6 0-1 .4-1 1v5.6"/><path d="m10 11 11 .9c.6 0 .9.5.8 1.1l-.8 5c-.1.5-.6.9-1 .9H15"/><circle cx="7" cy="15" r="5"/><circle cx="7" cy="15" r="1"/><circle cx="19" cy="17" r="2"/>',
  "graduation-cap":
  ...
  printer:
    '<path d="M6 9V2a1 1 0 0 1 1-1h10a1 1 0 0 1 1 1v7"/><path d="M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2"/><rect x="6" y="14" width="12" height="8" rx="1"/>',
  "share-2":
...
export function Icon({
  ...
  const inner = PATHS[name as string] ?? PATHS.circle;
  return (
    <svg
      width={px}
      height={px}
